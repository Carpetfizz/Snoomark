...
var SMCanvas = React.createClass({displayName: "SMCanvas",
	...
	render: function(){
		return (
			React.createElement("div", null, 
				React.createElement("canvas", {ref: "canvas", id: "smcanvas"})
			)
		);
	}
});
...
var SMDropper = React.createClass({displayName: "SMDropper",
	componentDidMount: function(){
...
},{"../components/SMDropper.jsx":2,"react":160}],4:[function(require,module,exports){
		...
		if(this.state.mainImage.url){
			content = (
				React.createElement("div", null, 
					...
					React.createElement(SMCanvas, {ref: "smcanvas", onInit: this.canvasOnInit, handleSaveImage: this.handleDownloadImage, mainImageURL: this.state.mainImage.url, mainImageType: this.state.mainImage.type})
				)
			)
		} 
		return (
...
},{"../components/SMCanvas.jsx":1,"../components/SMFileLoader.jsx":3,"../lib/download.min.js":4,"react":160}]},{},[161,1,2,3])
